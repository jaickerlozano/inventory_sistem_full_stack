...
from inventory.views import ProductViewSet, CategoryViewSet, SupplierViewSet, StockMovementViewSet, DashboardView, AlertsView
...
urlpatterns = [
    ...
    path('api/inventory/alerts/', AlertsView.as_view(), name='alerts'),
